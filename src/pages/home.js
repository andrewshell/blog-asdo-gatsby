...
export default function IndexPage({data}) {
  ...
  return (
    <Layout>
      ...
      <p class="p-note">I'm <a className="url fn" href={ permalink }>Andrew Shell</a>, a <span className="p-role">software developer</span> in <span className="p-adr"><span className="p-locality">Madison</span>, <abbr title="Wisconsin" className="p-region">WI</abbr></span>. I founded Madison PHP (now <a rel="nofollow" href="https://www.meetup.com/fullstackmadison/">Full Stack Madison</a>) and Co-Founded <a rel="nofollow" href="https://pinpointsoftware.com/">Pinpoint Software</a>. Currently I'm a Senior Web Developer at <a rel="nofollow" href="https://www.linkedin.com/company/johnson-health-tech-na/" className="org">Johnson Health Tech</a>.</p>
...
export const query = graphql`query OldHomePageQuery{
  site {
    siteMetadata {
      siteUrl
    }
